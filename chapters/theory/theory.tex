...
\section{Gradient Descent}\label{seq:gradient-descent}
...
towards smaller function values, i.e a minimum. The parameter $\gamma_k$ is often
referred to as step length or \textit{learning rate}. We will be using the latter term
in this thesis.
