...
\input{chapters/theory/figures/detector_image_sample.tex}
...
The detector signal is modeled using a constant baseline plus a logistic rise 
...
be the same or similar. We can use these energies as a performance indicator for our
models when it comes to energy prediction.
